        ...
        <div class="page">
            ...
            <div class="swiper-main">
                <div ref="swiper-container" class="swiper-container">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide" v-for="(item,index) in slides" :key="index"><img :src="item.image"
                                                                                                   :alt="item.title">
                        </div>
                    </div>
            ...
            <div class="quick-nav">
                <ul v-for="(item,index) in navs" :key="index">
                    <li><img src="../../../assets/images/common/lazyImg.jpg" :data-echo="item.image" :alt="item.title">
                    </li>
                    <li>{{item.title}}</li>
                </ul>
            </div>
                ...
                <div class="goods-wrap" :key="index" v-if="(index+1)%2==1">
                    ...
                    <div class="goods-level-1">
                        ...
                        <div class="goods-list" @click="goPage('/goods/details')">
                            ...
                            <div class="image"><img :src="item.items[0].image"
                                                    :data-echo="item.items && item.items[0].image" alt=""></div>
                        </div>
                        <!--右边部分-->
                        <div class="goods-list-2">
                            <!--判断线 :class="index2==1?'goods-row noline':'goods-row'"-->
                            <div :class="index2==1?'goods-row noline':'goods-row'"
                                 v-for="(item2,index2) in item.items.slice(1,3)" :key="index2">
                                <div class="goods-title">{{item2.title}}</div>
                                <div class="tip">品质精挑</div>
                                <div class="image"><img src="../../../assets/images/common/lazyImg.jpg"
...
<style scoped>
    ...
    .quick-nav ul li:nth-child(1) img {
        width: 100%;
        height: 100%;
    }
    ...
    .goods-wrap .goods-level-1 .goods-list {
        width: 50%;
        height: 100%;
    ...
    .goods-wrap .goods-level-1 .goods-list .goods-title {
        width: 95%;
        height: 0.4rem;
        position: absolute;
        z-index: 1;
    ...
    .goods-wrap .goods-level-1 .goods-list .tip {
        width: auto;
        height: auto;
        position: absolute;
        left: 0.1rem;
    ...
    .goods-wrap .goods-level-1 .goods-list .price-1 {
        width: 0.8rem;
        height: 0.4rem;
        border-radius: 10px;
        color: #FFFFFF;
    ...
    .goods-wrap .goods-level-1 .goods-list .price-3 {
        width: 0.8rem;
        height: 0.4rem;
        border-radius: 10px;
        color: #FFFFFF;
    ...
    .goods-wrap .goods-level-1 .goods-list .image {
        width: 3rem;
        height: 2rem;
        position: absolute;
        left: 0.4rem;
    ...
    .goods-wrap .goods-level-1 .goods-list .image img {
        width: 100%;
        height: 100%;
    }

    .goods-wrap .goods-level-1 .goods-list-2 {
        width: 50%;
        height: 100%;
    }

    .goods-wrap .goods-list-2 .goods-row {
        width: 100%;
        height: 49.5%;
        border-bottom: 1px solid #CCCCCC;
        position: relative;
    ...
    .goods-wrap .goods-list-2 .goods-row.noline {
        border-bottom: 0px;
    }

    .goods-wrap .goods-list-2 .goods-row .goods-title {
        width: 55%;
        height: 0.4rem;
        font-size: 0.28rem;
        overflow: hidden;
    ...
    .goods-wrap .goods-list-2 .goods-row .tip {
        font-size: 0.28rem;
        color: #7b7f82;
        position: absolute;
        left: 0.2rem;
    ...
    .goods-wrap .goods-list-2 .goods-row .image {
        width: 1.2rem;
        height: 1.2rem;
        position: absolute;
        right: 0.2rem;
    ...
    .goods-wrap .goods-list-2 .goods-row .image img {
        width: 100%;
        height: 100%
    }

    .goods-wrap .goods-level-2 {
        width: 100%;
        display: flex;
    }

    .goods-wrap .goods-level-2 .goods-list {
        width: 25%;
        height: 3.2rem;
        border-right: 1px solid #CCCCCC;
    }

    .goods-wrap .goods-level-2 .goods-title {
        width: 100%;
        height: 0.4rem;
        font-size: 0.28rem;
        overflow: hidden;
    ...
    .goods-wrap .goods-level-2 .goods-list .image {
        width: 1.5rem;
        height: 1.5rem;
        margin: 0 auto;
        margin-bottom: 0.2rem;
    ...
    .goods-wrap .goods-level-2 .goods-list .image img {
        width: 100%;
        height: 100%;
    }

    .goods-wrap .goods-level-2 .goods-list .price {
        color: #d32a4e;
        font-size: 0.28rem;
        text-align: center;
    }

    .goods-wrap .goods-level-2 .goods-list .line-price {
        color: #7b7f82;
        font-size: 0.28rem;
        text-align: center;
    ...
    .goods-wrap .goods-level-1 .goods-column {
        width: 50%;
        border-right: 1px solid #CCCCCC;
    }

    .goods-wrap .goods-level-1 .goods-column .goods-title {
        width: 90%;
        height: 0.4rem;
        text-align: center;
        font-size: 0.28rem;
    ...
    .goods-wrap .goods-level-1 .goods-column .tip {
        width: 100%;
        color: #7b7f82;
        font-size: 0.24rem;
        text-align: center;
    ...
    .goods-wrap .goods-level-1 .goods-column .image {
        width: 1.8rem;
        height: 2rem;
        margin: 0 auto;
        margin-top: 0.2rem;
    ...
    .goods-wrap .goods-level-1 .goods-column .image img {
        width: 100%;
        height: 100%;
    }

    .goods-wrap .goods-name-2 {
        width: 100%;
        height: 0.62rem;
        font-size: 0.32rem;
        text-align: center;
    ...
    .goods-recom .goods-list .image img {
        width: 100%;
        height: 100%;
    }

    .goods-recom .goods-list .price {
        font-size: 0.32rem;
        color: #d32a4e;
        margin-top: 0.1rem;
    }
